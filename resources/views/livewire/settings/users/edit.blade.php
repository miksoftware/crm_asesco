<div class="max-w-2xl mx-auto">
    ...
    <div class="mb-6">
        ...
        <p class="text-gray-500 text-sm">Modifica los datos del usuario</p>
    </div>
        ...
        <form wire:submit="save" class="space-y-5">
            ...
            <div>
                ...
                <label class="relative inline-flex items-center cursor-pointer">
                    <input type="checkbox" wire:model="isActive" class="sr-only peer" {{ $user->id === auth()->id() ? 'disabled' : '' }}>
                ...
                @if($user->id === auth()->id())
                    <p class="mt-1 text-xs text-orange-500">No puedes desactivar tu propia cuenta</p>
                @else
            ...
            <div class="border-t border-gray-200 pt-5">
                <p class="text-sm text-gray-500 mb-4">Deja los campos de contraseña vacíos si no deseas cambiarla</p>
