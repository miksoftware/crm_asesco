<div class="max-w-4xl mx-auto">
    ...
    <div class="mb-6">
        ...
        <p class="text-gray-500 text-sm">Modifica el rol y sus permisos</p>
    </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                <div>
                    ...
                    <input wire:model="name" type="text" id="name" 
                           class="block w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-all @error('name') border-red-500 @enderror {{ $role->name === 'admin' ? 'bg-gray-100' : '' }}"
