...
<head>
    ...
    <title>Enlace no válido - ASESCO BPO</title>
...
<body class="min-h-screen bg-gray-50 flex items-center justify-center p-4">
    <div class="max-w-md w-full">
        <div class="bg-white rounded-2xl shadow-xl border border-gray-100 p-8 text-center">
            ...
            <h1 class="text-2xl font-bold text-gray-900 mb-2">Enlace no disponible</h1>
            <p class="text-gray-600 text-sm mb-6">
                {{ $message ?? 'Este enlace no es válido o ha expirado.' }}
            </p>

            <p class="text-xs text-gray-400">
                Si necesitas enviar un soporte de pago, contacta a tu asesor para que te genere un nuevo enlace.
            </p>
        </div>
